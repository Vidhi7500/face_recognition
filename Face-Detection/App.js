...
mongoose.connect(
  "mongodb+srv://Vidhi:Vidhi7500@cluster0.xmermvc.mongodb.net/",
  {
...
const userSchema = new mongoose.Schema({
  ...
  gender: String,
  token: String,
  descriptor: [Object], // Array of descriptor objects
});
        ...
        try {
          if (model.elements.faceMatch[0].status === 1) {
            ...
            const newUser = new User({
              ...
              expressions: model.elements.faceMatch[0].expressions,
            ...
            res.status(500).send({ status: 0, err: "An error occurred" });
          }
        } catch (err) {
